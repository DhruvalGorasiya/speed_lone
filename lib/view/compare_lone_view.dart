...
class CompareLoneCalculator extends StatelessWidget {
  ...
  final CompareLoneCalculatorController compareLoneCalculatorController =
      Get.put(CompareLoneCalculatorController());

  @override
  Widget build(BuildContext context) {
    return GetBuilder<CompareLoneCalculatorController>(
      builder: (controller) {
        return Scaffold(
                          ...
                          child: Column(
                            children: [
                              ...
                              customSlider(
                                ...
                                min: 1,
                                max: 500000,
                                showValue: controller.loanAmount.value
                                    .toStringAsFixed(0),
